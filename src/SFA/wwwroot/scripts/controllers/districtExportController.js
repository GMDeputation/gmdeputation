app.controller('districtExportController', function ($scope, $window, $location, $mdDialog, districtService) {
    $scope.file = {};
    ...
    $scope.download = function () {
        $window.location.href = '/resources/districts/District.xlsx';
    };
    ...
    $scope.save = function () {
        ...
        districtService.export(fd).then(processSuccess, processError);
    };
        ...
        if (obj.data === "") {
            $mdDialog.show(
                $mdDialog.alert()
                    ...
                    .title('Church Admin')
                    .textContent("Districts saved successfully")
