app.controller('stateExportController', function ($scope, $window, $location, $mdDialog, stateService) {
    $scope.file = {};
    ...
    $scope.download = function () {
        $window.location.href = '/resources/states/State.xlsx';
    };
    ...
    $scope.save = function () {
        ...
        stateService.export(fd).then(processSuccess, processError);
    };
        ...
        if (obj.data === "") {
            $mdDialog.show(
                $mdDialog.alert()
                    ...
                    .title('Church Admin')
                    .textContent("States saved successfully")
